...
flags.DEFINE_float("steps_per_epoch", 5, "Steps per epoch")
flags.DEFINE_integer("max_steps", 100, "Maximum number of training iterations")
...
flags.DEFINE_integer("lower_iter", 10, "initial iteration to be tested - default 1000")
flags.DEFINE_integer("higher_iter", 40, "final iteration to be tested - default 40000")
...
def main():
    ...
    with tf.Session() as sess:
        ...
        number_of_iter = int((FLAGS.higher_iter - FLAGS.lower_iter) / 10) + 1
        ...
        for i in range(number_of_iter):
            ...
            if i==0:
                ...
                increment = int(FLAGS.lower_iter) + (i*10)
            ...
            iter_T = int(FLAGS.lower_iter) + (i*10)
            f.write( str(iter_T) + ' ' + str(Test_IoU) + '\n' )
            IoU_for_plot.append(Test_IoU)


    f.close()
    plt.plot(IoU_for_plot)
    plt.savefig("IoU.png")
